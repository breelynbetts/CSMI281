...
public class LinkedForneymonegerieTests {
    ...
    public void testTypeSize() {
        fm.collect("Dampymon");
//        System.out.println(fm.findType("Dampymon"));
        fm.collect("Dampymon");
//        System.out.println(fm.findType("Dampymon"));
    ...
    public void testIteratorBasics() {
        ...
        // Test next()
        LinkedForneymonegerie dolly = fm.clone();
        System.out.println("OG DOLLY 1: " + dolly.toString());
        while (true) {
            String gotten = it.getType();
            assertTrue(dolly.contains(gotten));
            dolly.release(gotten);
            System.out.println("UPDATED DOLLY 1: " +  dolly.toString() );
            System.out.println("DOLLY SIZE: " + dolly.size());
            if (it.hasNext()) {it.next();} else {break;}
        }
        System.out.println("NEW DOLLY 1: " +  dolly.toString() );
        assertTrue(dolly.empty());
        assertFalse(it.hasNext());
        
        // Test prev()
        dolly = fm.clone();
        System.out.println("OG Dolly: " + dolly.toString());
        while (true) {
            String gotten = it.getType();
            assertTrue(dolly.contains(gotten));
            dolly.release(gotten);
        ...
        System.out.println("New Dolly: " +  dolly.toString() );
        System.out.println("Is dolly empty?: " + dolly.empty());
        System.out.println("Dolly size: " + dolly.size());
        assertTrue(dolly.empty());
